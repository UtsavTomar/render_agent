...
class CrewaiPlusLeadScoringCrew:
    ...
    def lead_analysis_agent(self) -> Agent:
        return Agent(
            ...
            verbose=True,
            output_file="lead_analysis_agent.md",
        )
    ...
    def scoring_and_planning_agent(self) -> Agent:
        return Agent(
            ...
            tools=[SerperDevTool(), ScrapeWebsiteTool()],
            verbose=True,
            output_file="scoring_and_planning_agent.md",
        )
    ...
    def lead_analysis_task(self) -> Task:
        return Task(
            ...
            output_file="lead_analysis_task.md",
        )
    ...
    def scoring_and_planning_task(self) -> Task:
        return Task(
            ...
            output_file="scoring_and_planning_task.md",
        )
